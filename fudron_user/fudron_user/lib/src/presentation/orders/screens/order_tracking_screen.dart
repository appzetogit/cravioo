...
class _OrderTrackingScreenState extends ConsumerState<OrderTrackingScreen> {
  ...
  void _shareOrder(OrderModel order) {
    ...
    final parts = [
      'My Fudron order${order.restaurantName.isEmpty ? '' : ' from ${order.restaurantName}'}',
    ...
    return _Card(
      child: Row(
        children: [
          ...
          const SizedBox(width: 12),
          Expanded(
            child: Text('Your order is protected with Fudron delivery safety.', style: TextStyle(fontSize: 13, color: secondary)),
          ),
        ],
      ),
    );
