...
class AboutScreen extends StatelessWidget {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSectionTitle('Why Choose Lagech?', isDark),
  ...
  /// 1. Hero Card: Lagech Logo + Subtitle + Headline + Description + 3D Illustration
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: isDark
              ? [AppColors.primaryTintDark, AppColors.primaryTintDarkStrong]
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                // Description
                Text(
                  'Lagech is your trusted food delivery platform, connecting you with the best restaurants, cafés and food partners. Fresh meals, quick delivery and delightful experiences – all at your fingertips.',
                  style: TextStyle(
                    fontSize: 11.sp,
                    height: 1.35,
                    color: secondaryTextColor,
          ...
          // Right Illustration (icon-based, no logo image)
          SizedBox(
            width: 135.w,
            height: 150.h,
            child: Container(
  ...
  /// 4. Why Choose Lagech Card (6 Features Grid)
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  'Thank you for being a part of Lagech!',
                  style: TextStyle(
                    fontSize: 12.5.sp,
                    fontWeight: FontWeight.bold,
                    color: textColor,
