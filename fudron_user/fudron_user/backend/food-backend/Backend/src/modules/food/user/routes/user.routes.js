...
import {
    getPayLaterAccountController,
    repayFromWalletController,
    startRazorpayRepaymentController,
    verifyRazorpayRepaymentController
} from '../controllers/payLater.controller.js';
...
// Pay Later (Bearer USER)
router.get('/pay-later', getPayLaterAccountController);
router.post('/pay-later/repay/wallet', repayFromWalletController);
router.post('/pay-later/repay/razorpay/start', startRazorpayRepaymentController);
router.post('/pay-later/repay/razorpay/verify', verifyRazorpayRepaymentController);
