...
const paymentSchema = new mongoose.Schema(
    {
        ...
        status: {
            ...
            enum: [
                ...
                'refunded',
                'pending_qr',
                // Order was placed on credit; nothing was collected. Stays this
                // way until the user repays (payLater.repay), which flips it to
                // 'paid' the same as any other settled order.
                'pay_later_due'
            ],
            default: 'cod_pending'
        },
