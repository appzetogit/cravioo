          ...
          children: [
            Container(
              ...
              child: Image.asset(
                ...
                errorBuilder: (_, _, _) => Icon(Icons.fastfood, color: Colors.grey[400], size: 40.sp),
              ),
            ),
          ],
        ),
        ...
        Row(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: Colors.white,
                border: Border.all(color: _priceGreen.withValues(alpha: 0.3)),
                borderRadius: BorderRadius.circular(8.r),
              ),
              child: Text(
                'ADD',
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            height: 12.h,
            decoration: BoxDecoration(
              color: isActive ? _priceGreen.withValues(alpha: 0.2) : Colors.grey.shade300,
