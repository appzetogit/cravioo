...
export async function createInitialTransaction(order) {
    ...
    const transaction = new FoodTransaction({
        ...
        pricing: {
            ...
            foodGst: Number(order.pricing?.foodGst || 0) || 0,
            foodGstRate: Number(order.pricing?.foodGstRate || 0) || 0,
            platformFeeGross: Number(order.pricing?.platformFeeGross || 0) || 0,
            platformFeeGst: Number(order.pricing?.platformFeeGst || 0) || 0,
            platformFeeGstRate: Number(order.pricing?.platformFeeGstRate || 0) || 0,
            packagingFeeGross: Number(order.pricing?.packagingFeeGross || 0) || 0,
            packagingFeeGst: Number(order.pricing?.packagingFeeGst || 0) || 0,
            packagingFeeGstRate: Number(order.pricing?.packagingFeeGstRate || 0) || 0,
