...
function slimPricing(pricing) {
  ...
  return {
    ...
    platformFeeGross: pricing.platformFeeGross,
    platformFeeGst: pricing.platformFeeGst,
    platformFeeGstRate: pricing.platformFeeGstRate,
    packagingFeeGross: pricing.packagingFeeGross,
    packagingFeeGst: pricing.packagingFeeGst,
    packagingFeeGstRate: pricing.packagingFeeGstRate,
...
export const RESTAURANT_ORDER_LIST_SELECT = [
  ...
  "pricing.foodGst",
  "pricing.foodGstRate",
  "pricing.platformFeeGross",
  "pricing.platformFeeGst",
  "pricing.platformFeeGstRate",
  "pricing.packagingFeeGross",
  "pricing.packagingFeeGst",
  "pricing.packagingFeeGstRate",
