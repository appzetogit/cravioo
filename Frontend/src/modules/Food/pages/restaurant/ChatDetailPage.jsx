    ...
    <div className="min-h-screen bg-[#f6e9dc] flex flex-col overflow-hidden">
      ...
      <div className="bg-white border-b border-gray-200 px-4 py-4 md:py-3 flex items-center gap-4 rounded-b-3xl md:rounded-b-none fixed top-0 left-0 right-0 z-50">
        ...
        <div className="flex-1 flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-[#32C45A] flex items-center justify-center flex-shrink-0">
          ...
          >
            <div
              className={`max-w-[75%] md:max-w-[60%] rounded-2xl px-4 py-2.5 ${
                msg.sender === "me"
                  ? "bg-[#32C45A] text-white rounded-br-sm"
      ...
      <div className="bg-white border-t border-gray-200 px-4 py-3 fixed bottom-0 left-0 right-0 z-40 md:relative md:border-t-0 md:bottom-auto">
        <div className="flex items-center gap-3">
          <Input
            ...
            className="flex-1 rounded-full border border-gray-200 focus:border-[#32C45A] focus:ring-1 focus:ring-[#32C45A]"
          />
          <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
            <Button
              onClick={handleSend}
              disabled
              className="rounded-full bg-[#32C45A] hover:bg-[#28A047] text-white p-2.5 w-10 h-10 flex-shrink-0 disabled:opacity-50 disabled:cursor-not-allowed"
            >
