      ...
      <form onSubmit={handleSubmit} className="mx-4 mt-4 space-y-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-3 bg-white dark:bg-[#1c1c1e] text-gray-900 dark:text-white border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-[#32C45A] focus:border-transparent"
            required
          >
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-white dark:bg-[#1c1c1e] text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-[#32C45A] focus:border-transparent"
            required
            maxLength={200}
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={6}
            className="w-full px-4 py-3 bg-white dark:bg-[#1c1c1e] text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-[#32C45A] focus:border-transparent resize-none"
            required
            maxLength={1000}
          />
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#1c1c1e] border-t border-gray-200 dark:border-gray-800 p-4 z-20">
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-[#32C45A] text-white py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-[#28A047] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {submitting ? (
              <>
