...
const replacement = `{/* Border Glow Effect */}
                            <div className="absolute inset-0 rounded-md pointer-events-none z-0 transition-all duration-300 border border-transparent group-hover:border-[#32C45A]/30 group-hover:shadow-[inset_0_0_0_1px_rgba(235,89,14,0.2)]" />
                           </Card>
                         </Link>
                       </div>
                     </LazyComponent>
