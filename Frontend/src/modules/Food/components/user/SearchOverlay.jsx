          ...
          <form onSubmit={handleSearchSubmit} className="flex items-center gap-4">
            <div className="flex-1 relative">
              ...
              <Input
                ...
                className="pl-12 pr-12 h-12 w-full bg-white dark:bg-[#1a1a1a] border-gray-100 dark:border-gray-800 focus:border-[#32C45A] dark:focus:border-[#32C45A] rounded-full text-lg dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400"
              />
              <button
                type="button"
                onClick={handleVoiceSearch}
                className={`absolute right-3 top-1/2 -translate-y-1/2 p-2 rounded-full transition-all ${isListening ? 'text-[#32C45A] scale-110 animate-pulse' : 'text-gray-400 hover:text-gray-600'}`}
              >
              ...
              {filteredFoods.map((food, index) => (
                ...
                >
                  ...
                  <div className="px-1 sm:px-2 text-center">
                    <span className="text-xs sm:text-sm font-semibold text-gray-800 dark:text-gray-200 group-hover:text-[#32C45A] dark:group-hover:text-red-400 transition-colors line-clamp-2">
                      {food.name}
                    </span>
                  </div>
                </div>
