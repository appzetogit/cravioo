                    ...
                    {restaurant?.outlets && Array.isArray(restaurant.outlets) && restaurant.outlets.length > 0 ? (
                      <div className="space-y-2">
                        {restaurant.outlets.map((outlet) => (
                          ...
                          >
                            {outlet?.isNearest && (
                              <div className="flex items-center gap-1.5 mb-2 px-2 py-1 bg-red-50 dark:bg-[#32C45A]/20 rounded-md">
                                <Zap className="h-3.5 w-3.5 text-[#32C45A] dark:text-[#32C45A] fill-[#32C45A] dark:fill-[#32C45A]" />
                                <span className="text-xs font-semibold text-[#32C45A] dark:text-[#32C45A]">
